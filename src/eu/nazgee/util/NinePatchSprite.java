...
public class NinePatchSprite {
	...
	public void setHeight(final float pHeight) {
		...
		mPatch[NinePatchTextureRegionBatch.BOTTOM_LEFT].setPosition(
				mPatch[NinePatchTextureRegionBatch.BOTTOM_LEFT].getX(), y);
		mPatch[NinePatchTextureRegionBatch.BOTTOM_CENTER].setPosition(
				mPatch[NinePatchTextureRegionBatch.BOTTOM_CENTER].getX(), y);
		mPatch[NinePatchTextureRegionBatch.BOTTOM_RIGHT].setPosition(
				mPatch[NinePatchTextureRegionBatch.BOTTOM_RIGHT].getX(), y);
	}
