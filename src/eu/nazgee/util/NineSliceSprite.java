 ...
 */
public class NineSliceSprite extends RectangularShape {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public NineSliceSprite(final float pX, final float pY,
			...
			final float pInsetTop, final float pInsetRight,
			final float pInsetBottom,
			final VertexBufferObjectManager pVertexBufferObjectManager) {
		this(pX, pY, pTextureRegion, pInsetLeft, pInsetTop, pInsetRight,
				pInsetBottom, pVertexBufferObjectManager,
	...
	public NineSliceSprite(final float pX, final float pY,
		...
		this(pX, pY, pTextureRegion.getWidth(), pTextureRegion.getHeight(),
				pTextureRegion, pInsetLeft, pInsetTop, pInsetRight,
				pInsetBottom, pVertexBufferObjectManager, pShaderProgram);
	}
	...
	public NineSliceSprite(final float pX, final float pY, final float pWidth,
			...
			final VertexBufferObjectManager pVertexBufferObjectManager) {
		this(pX, pY, pWidth, pHeight, pTextureRegion, pInsetLeft, pInsetTop,
				pInsetRight, pInsetBottom, pVertexBufferObjectManager,
				PositionColorTextureCoordinatesShaderProgram.getInstance());
	}
	...
	public NineSliceSprite(final float pX, final float pY, final float pWidth,
		...
		this.mSpriteBatch = new SpriteBatch(texture, 9,
	...
	public void setInsets(final float pInsetLeft, final float pInsetTop,
			final float pInsetRight, final float pInsetBottom) {
		this.mInsetLeft = pInsetLeft;
		this.mInsetTop = pInsetTop;
		this.mInsetRight = pInsetRight;
	...
	private void updateTextureRegions() {
		...
		final float centerWidth = baseWidth - this.mInsetLeft
				- this.mInsetRight;
		final float centerHeight = baseHeight - this.mInsetTop
				- this.mInsetBottom;
		...
		this.mTopLeftTextureRegion.set(leftX, topY, this.mInsetLeft,
				this.mInsetTop);
		this.mTopCenterTextureRegion.set(centerX, topY, centerWidth,
				this.mInsetTop);
		this.mTopRightTextureRegion.set(rightX, topY, this.mInsetRight,
				this.mInsetTop);

		/* Center. */
		final float centerY = baseY + this.mInsetTop;
		this.mCenterLeftTextureRegion.set(leftX, centerY, this.mInsetLeft,
				centerHeight);
		this.mCenterTextureRegion.set(centerX, centerY, centerWidth,
				centerHeight);
		this.mCenterRightTextureRegion.set(rightX, centerY, this.mInsetRight,
				centerHeight);

		/* Bottom. */
		final float bottomY = (baseY + baseHeight) - this.mInsetBottom;
		this.mBottomLeftTextureRegion.set(leftX, bottomY, this.mInsetLeft,
				this.mInsetBottom);
		this.mBottomCenterTextureRegion.set(centerX, bottomY, centerWidth,
				this.mInsetBottom);
		this.mBottomRightTextureRegion.set(rightX, bottomY, this.mInsetRight,
				this.mInsetBottom);
	}
	...
	private void updateVertices() {
		...
		final float centerWidth = this.mWidth - this.mInsetLeft
				- this.mInsetRight;
		final float centerHeight = this.mHeight - this.mInsetTop
				- this.mInsetBottom;
		...
		/* Top. */
		final float topY = 0;
		this.mSpriteBatch.draw(this.mTopLeftTextureRegion, leftX, topY,
				this.mInsetLeft, this.mInsetTop, color);
		this.mSpriteBatch.draw(this.mTopCenterTextureRegion, centerX, topY,
				centerWidth, this.mInsetTop, color);
		this.mSpriteBatch.draw(this.mTopRightTextureRegion, rightX, topY,
				this.mInsetRight, this.mInsetTop, color);

		/* Center. */
		final float centerY = this.mInsetBottom;
		this.mSpriteBatch.draw(this.mCenterLeftTextureRegion, leftX, centerY,
				this.mInsetLeft, centerHeight, color);
		this.mSpriteBatch.draw(this.mCenterTextureRegion, centerX, centerY,
				centerWidth, centerHeight, color);
		this.mSpriteBatch.draw(this.mCenterRightTextureRegion, rightX, centerY,
				this.mInsetRight, centerHeight, color);

		/* Bottom. */
		final float bottomY = this.mHeight - this.mInsetTop;
		this.mSpriteBatch.draw(this.mBottomLeftTextureRegion, leftX, bottomY,
				this.mInsetLeft, this.mInsetBottom, color);
		this.mSpriteBatch.draw(this.mBottomCenterTextureRegion, centerX,
				bottomY, centerWidth, this.mInsetBottom, color);
		this.mSpriteBatch.draw(this.mBottomRightTextureRegion, rightX, bottomY,
				this.mInsetRight, this.mInsetBottom, color);
