...
import eu.nazgee.game.flower.activity.pager.ArrayLayout.eAnchorPointXY;
import eu.nazgee.game.utils.loadable.SimpleLoadableResource;

public class ScenePagerLevel extends ScenePager{

	private final MyResources mResources = new MyResources();

	public ScenePagerLevel(float W, float H,
