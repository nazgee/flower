...
public enum Seed {
	...
	SEED6(6,	200,	5,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE, Color.BLUE),
	SEED7(7,	300,	6,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE, Color.YELLOW, Color.BLUE),
	SEED8(8,	300,	7,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE, Color.YELLOW, Color.BLUE),
	SEED9(9,	300,	8,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE, Color.YELLOW, Color.BLUE),
	SEED10(10,	500,	9,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED11(11,	500,	10,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED12(12,	500,	11,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED13(13,	800,	12,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED14(14,	800,	13,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED15(15,	800,	14,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED16(16,	1300,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED17(17,	1300,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED18(18,	1300,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED19(19,	2100,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED20(20,	2100,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED21(21,	2100,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED22(22,	3400,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED23(23,	3400,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE),
	SEED24(24,	3400,	15,	TexturesMisc.SEEDS_001_ID,	true, 	Color.WHITE);
