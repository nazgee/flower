...
public enum Seed {
	...
	SEED7(7,	300,	6,	0,	true, 	Color.WHITE, Color.YELLOW, Color.BLUE),
	SEED8(8,	300,	7,	0,	true, 	Color.WHITE, Color.YELLOW, Color.BLUE),
	SEED9(9,	300,	8,	0,	true, 	Color.WHITE, Color.YELLOW, Color.BLUE),
