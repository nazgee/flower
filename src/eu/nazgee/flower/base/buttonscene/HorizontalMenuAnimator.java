...
public class HorizontalMenuAnimator extends BaseMenuAnimator {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public HorizontalMenuAnimator() {
		this(VerticalAlign.BOTTOM, HorizontalAlign.CENTER, 0);
	}

	public HorizontalMenuAnimator(final VerticalAlign pVerticalAlign,
			final HorizontalAlign pHorizontalAlign, float pVerticalOffset){
		super(pHorizontalAlign, EaseStrongOut.getInstance());
